...
sudo dnf install fastfetch hyprland hypridle hyprlock xdg-desktop-portal-hyprland awww asusctl asusctl-rog-gui kitty grimshot rust cargo wallust cliphist rofi zsh ImageMagick
chsh -s $(which zsh)
